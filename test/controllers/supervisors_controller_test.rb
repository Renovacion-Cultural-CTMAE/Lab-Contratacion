...
class SupervisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supervisor" do
    assert_difference("Supervisor.count") do
      post supervisors_url, params: { supervisor: { apellido: @supervisor.apellido, cargo: @supervisor.cargo, cedula_supervisor: @supervisor.cedula_supervisor, correo: @supervisor.correo, nombre: @supervisor.nombre, telefono: @supervisor.telefono } }
    end
  ...
  test "should update supervisor" do
    patch supervisor_url(@supervisor), params: { supervisor: { apellido: @supervisor.apellido, cargo: @supervisor.cargo, cedula_supervisor: @supervisor.cedula_supervisor, correo: @supervisor.correo, nombre: @supervisor.nombre, telefono: @supervisor.telefono } }
