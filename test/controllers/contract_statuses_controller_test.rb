...
class ContractStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract_status" do
    assert_difference("ContractStatus.count") do
      post contract_statuses_url, params: { contract_status: { fecha_del_estado: @contract_status.fecha_del_estado, motivos_contrato: @contract_status.motivos_contrato, numero_contrato: @contract_status.numero_contrato } }
    end
  ...
  test "should update contract_status" do
    patch contract_status_url(@contract_status), params: { contract_status: { fecha_del_estado: @contract_status.fecha_del_estado, motivos_contrato: @contract_status.motivos_contrato, numero_contrato: @contract_status.numero_contrato } }
